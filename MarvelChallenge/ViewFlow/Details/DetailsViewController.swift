    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row <= (setSections.count - 1) {
            ...
            case "CellEvents":
                ...
                let cell = ListCollectionViewCell.buildCellInCollection(collectionView, cellForItemAt: indexPath, resultData: infoItem, isCharacter: false, isDetail: true)
                return cell
            ...
            case "Description":
                ...
                cell.character = self.infoItem
                self.descriptionText = cell.characterDetail
                return cell
